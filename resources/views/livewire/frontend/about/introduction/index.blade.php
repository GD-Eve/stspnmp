<div>
    ...
    <main class="">
        <div class="flex">
            ...
            <!--content-->
            <div class="lg:flex-1 pb-10 ">
                <div
                    class="pt-5 md:pt-10 lg:pt-11 px-3 md:px-6 lg:px-20 text-[#333] text-base md:text-lg leading-7 md:leading-8 ">
                    <div class="relative flex justify-between ">
                        ...
                        <!--logo-->
                        <div class="flex space-x-5 md:space-x-10  justify-between">
                            <div class="w-[30%]">
