                ...
                <div class="pt-5 md:pt-10 lg:pt-11 lg:space-y-10">
                    <div class="pb-7">
                        <div class="inline-block group relative">
                            <div class="text-2xl md:text-4xl font-black">裝置藝術</div>
                            <div class=" absolute w-full h-1 bg-[#ffea00] bottom-0 left-0 -translate-y-[3px]">
                            </div>
                        </div>
                    </div>

                    <section class="py-5 lg:py-10 w-full border-t border-b border-dashed border-black">
                        <div class="flex flex-col md:flex-row items-center space-x-2">
                            <div class="w-[90%] lg:max-w-[360px]">
                                <img src="https://stsp.nmp.gov.tw/img/back/artDevice/2020-09-30/20200930102544754.jpg"
                                    alt="" class=" aspect-[360/280] w-full h-full object-cover">
                            </div>
                            <div class="py-3 px-4 lg:py-6 lg:px-8">
                                <p class="leading-9">相遇石頭埔</p>
                                <p>
                                    博物館基地位於石頭埔遺址上方，石頭埔為新市區東側的舊地名，「相遇石頭埔」是博物館「時空隧道」手扶梯的開端。
                                </p>
                            </div>
