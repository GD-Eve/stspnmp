    ...
    <header class="px-3 lg:px-5 py-[5px] lg:py-[11px] sticky top-0 left-0 bg-white z-30 text-base shadow-lg">
        <div class="">
            <div class="flex justify-between items-center lg:items-end text-[#666] text-base ">
                <!--left-->
                <a href="/" title="國立台灣史前文化博物館南科考古館" class="">
                    <img src="https://stsp.nmp.gov.tw/img/front/logo-footer.png" alt=""
                        class="w-[71%] xl:w-[204px] object-cover">
                </a>
                <!--手機/平板menu-->
                <div class="xl:hidden font-bold z-30">
                    <div class="px-1">
                        <div class="flex space-x-2 text-md" x-data="{ open: false }">
                            ...
                            <!--search-->
                            <div class="relative">
                                <div class="py-2 px-[6px] bg-[#ffea00] rounded-sm md:rounded-md  flex items-center justify-center w-[40px] lg:w-[60px] h-[40px] lg:h-[60px] cursor-auto z-30"  @click="open = ! open">
                                    ...
                                    <div class="space-y-3 text-base ">
                                        ...
                                        <div class="flex items-center space-x-4">
                                            <a href="" target="_blank" class="block">
                                                <img src="https://stsp.nmp.gov.tw/img/front/youtube_icon.png"
                                                    alt="Youtube" class=" aspect-square  h-full w-full object-cover">
                                            </a>
                                            <a href="" target="_blank" class="block">
                    ...
                    <div class="flex flex-col space-y-5 ">
                        ...
                        <div class="text-xs font-bold">
                            <div class=" flex justify-end items-center space-x-5">
                                ...
                                <a href="" class="block"><img src="https://stsp.nmp.gov.tw/img/front/search_icon.png"
                                        alt="" class=""></a>
    ...
    <script type="module">
        ...
        menuListOpenBtn.forEach((btn,i) => {
            btn.addEventListener('click',function(){
                if(menuBtnState[i] !== true){
                    gsap.to(menuListShow[i],{duration:0.3,height:'auto'}) 
                }else{
                    gsap.to(menuListShow[i],{duration:0.3,height:'0'}) 
                }
        ...
        tl.to('.menu',{
            ...
            .to('.menuwhite',{x:0})
            .to('.line01',{rotation:45,top:'50%',y:'-50%',duration:0.5},"<")
            .to('.line02',{opacity:0,duration:0.5 },'<')
            .to('.line03',{rotation:-45,bottom:'50%',y:'50%',duration:0.5},'<')
